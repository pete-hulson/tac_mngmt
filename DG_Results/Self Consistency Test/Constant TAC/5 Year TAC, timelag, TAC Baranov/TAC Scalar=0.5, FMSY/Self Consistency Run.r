...
TAC.CNST<-1                                         # 1='TRUE' 0='FALSE' if true TAC is held constant at level in first year, if false TAC is reset each year based on estimated abundance and FMSY, if both computes results for both
